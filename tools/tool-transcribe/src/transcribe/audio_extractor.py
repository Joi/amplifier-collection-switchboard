"""Audio Extractor - extracts audio from video files and compresses for API limits."""
...
class AudioExtractor:
    ...
    def __init__(self, temp_dir: Path | None = None):
        ...
        """
        self.temp_dir = temp_dir or Path.home() / ".local" / "share" / "transcribe" / "temp"
    ...
    def compress_for_api(self, audio_path: Path, max_size_mb: int = 25) -> Path:
        """Compress audio to fit within API size limit (25MB for OpenAI)."""
        ...
        try:
            ...
            target_bitrate = int((max_size_bytes * 8 * 0.9) / duration / 1000)
