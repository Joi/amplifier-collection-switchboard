...
def index():
    ...
    transcripts_dir = content_dirs[0] if content_dirs else paths.data_dir / "transcripts"
...
def transcribe(
    ...
    Examples:
        ...
        transcribe transcribe video.mp4 audio.mp3
        transcribe transcribe *.mp4 --resume
    """
    try:
